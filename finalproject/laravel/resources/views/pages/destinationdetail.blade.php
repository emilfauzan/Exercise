...
<!-- content start -->
<div class="container">
    <h4 class="pt-5 mt-3">Nusa Penida, Kelungkung, Bali</h4>
        ...
        <div class="col-md-4 col-12">
            <div class="cardputih">
                ...
                <div class="d-flex justify-content-between">
                    <h4 class="fw-bold my-auto">Nusa Peninda, Bali</h4>
                    <span class="my-auto"> <i class="fas fa-star" style="color: #f4eb00;"></i> 4.5</span>
                </div>
                <p>69 Reviews</p>
                <br>
                <p>Price</p>
                <h4 class="fw-bold">Rp. 1.000.000 / Pax</h4>
                <br>
                <button type="button" class="btn btn-success col-12">
                    <a class="nav-link text-white" href="{{ route('destinationcheckout') }}">Book Now</a>
                </button>
                <hr />
